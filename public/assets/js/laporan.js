document.addEventListener('DOMContentLoaded', function () {
    ...
    detailButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            document.getElementById('modal-laporan').innerText = button.dataset.laporan || '-';
            document.getElementById('modal-response').innerText = button.dataset.response || '-';
            document.getElementById('response-time').innerText = button.dataset.responsetime || '-';
