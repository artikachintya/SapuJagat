...
<div class="app-content-header">
    ...
    <div class="row page-title">
        <div class="col-sm-6"><h3 class="mb-0"><b>Daftar Laporan</b></h3></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="{{ route('pengguna.laporan.create') }}" class="btn btn-report">Buat Laporan</a>
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="card-body row">
                                    ...
                                    <div class="mb-3 p-3 rounded" style="background-color: #f9fdf9; border: 1px solid #d4ecd4;">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <span class="badge {{ $laporan->latestResponse ? 'bg-success' : 'bg-secondary' }}">
                                                {{ $laporan->latestResponse ? 'Sudah Ditanggapi' : 'Menunggu Respon' }}
                                            </span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button class="btn btn-outline-success lihat-detail-btn"
                                                ...
                                                data-response="{{ $laporan->latestResponse->response_message ?? 'Belum ada respon' }}"
                                                ...
                                                data-status="{{ $laporan->latestResponse ? 'Sudah Ditanggapi' : 'Menunggu Respon' }}"
                            ...
                            <div id="laporanModal" class="modal-overlay" style="display: none;">
                                <div class="modal-content">
                                    ...
                                    <div>
                                        <h6>Respon Admin Terakhir - <b id="response-time"></b></h6>
