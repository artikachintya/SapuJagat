                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- EDIT MODAL -->
                                <div class="modal fade" id="editTrashModal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content text-white" style="background:#34a853;">
                                            <div class="modal-header border-0">
                                                <h2 class="modal-title fw-bold w-100 text-center">BUAT / UBAH SAMPAH</h2>
                                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                            </div>

                                        <form id="editTrashForm" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Gambar Sampah</label>
                                            ...
                                            <div class="modal-footer border-0">
                                                <button type="submit" class="btn btn-light w-100 fw-bold">UBAH SAMPAH</button>
                                            </div>
                                        </form>
                                        </div>
                                    </div>
                                ...
                                <!-- CREATE MODAL -->
                                <div class="modal fade" id="createTrashModal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content text-white" style="background:#34a853;">
                                            <div class="modal-header border-0">
                                                <h2 class="modal-title w-100 text-center fw-bold">BUAT SAMPAH</h2>
                                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                            </div>
                                            ...
                                            <form id="createTrashForm"
                                                ...
                                                <div class="modal-footer border-0">
                                                <button type="submit" class="btn btn-light w-100 fw-bold">BUAT SAMPAH</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
