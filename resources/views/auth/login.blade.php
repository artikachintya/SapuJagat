        ...
        <div class="login-card">
            ...
            <div class="right">
                ...
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <label>Email</label>
                    <input type="email" name="email" required placeholder={{ __('login.email_placeholder')}}>

                    <label>{{ __('login.password')}}</label>
                    <input type="password" name="password" required placeholder={{ __('login.password_placeholder')}}>
