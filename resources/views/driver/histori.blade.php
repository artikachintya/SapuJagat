                                    ...
                                    <div class="modal-content">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div>
                                                ...
                                                <strong>Waktu Penjemputan: <br><span id="modal-start"></span></strong><br>
                                                <strong>Waktu Pengambilan Sampah:<br> <span id="modal-pickup"></span></strong><br>
                                                <strong>Waktu Pengantaran Selesai:<br> <span id="modal-arrival"></span></strong><br>
